        ...
        <div class="tab-pane  <?php if (!isset($edit_data) && !isset($personal_profile) && !isset($academic_result)) echo 'active'; ?>" id="list">
            <center>
                ...
                <table border="0" cellspacing="0" cellpadding="0" class="table table-bordered table-hover table-striped">
                    <tr>
                        <td style="font-weight:600;background:#ffa800;"><?php echo ('Select Exam'); ?></td>
                        <td style="font-weight:600;background:#ffa800;"><?php echo ('Select Subject'); ?></td>
                        <td style="font-weight:600;background:#ffa800;"><?php echo ('Options'); ?></td>
                    </tr>
                    <tr>
                        <td>
                        ...
                        <td>
                            ...
                            <select name="subject_id" class="form-control">
                                ...
                                foreach ($subjects as $row2) : ?>
                                    <option value="<?php echo $row2['subject_id']; ?>" <?php if (isset($subject_id) && $subject_id == $row2['subject_id'])
