...
<?php if ($date != '' && $month != '' && $year != '' && $class_id != '') : ?>
    ...
    <div class="row" style="color:#001911 ;font-family: system-ui;font-size:14px;" id="attendance_list">
    ...
    <div class="row" id="update_attendance" style="color:#001911 ;font-family: system-ui;font-size:14px;" id="update_attendance" style="color:#001911 ;font-family: system-ui;font-size:14px;">
