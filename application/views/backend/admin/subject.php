                ...
                <table class="table table-bordered table-hover table-striped datatable" id="table_export">
                    ...
                    <tbody>
                        ...
                        foreach ($subjects as $row) : ?>
                            <tr>
                                <td style="vertical-align:middle;"><?php echo $this->crud_model->get_type_name_by_id('class', $row['class_id']); ?></td>
                    ...
                    <div class="padded">
                        <div class="form-group">
                            ...
                            <div class=" form-group">
                                ...
                                <div class="col-sm-5">
                                    <select name="class_id" class="form-control" style="width:100%;" data-validate="required" data-message-required="<?php echo ('*This Field is Required'); ?>">
                                        <?php
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-5">
                                    <select name="teacher_id" class="form-control" style="width:100%;" data-validate="required" data-message-required="<?php echo ('*This Field is Required'); ?>">
                                        <?php
