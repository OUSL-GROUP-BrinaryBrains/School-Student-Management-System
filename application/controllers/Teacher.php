...
class Teacher extends CI_Controller
{
    ...
    function student_marksheet($class_id = '')
    {
        ...
        $page_data['page_title']     = 'Students Marksheet' . " : " .
            $this->crud_model->get_class_name($class_id);
        $page_data['class_id']     = $class_id;
        $this->load->view('backend/index', $page_data);
    }
    ...
    function marks($exam_id = '', $class_id = '', $subject_id = '')
    {
        ...
        if ($this->input->post('operation') == 'selection') {
            ...
            if ($page_data['exam_id'] > 0 && $page_data['class_id'] > 0 && $page_data['subject_id'] > 0) {
                ...
                $this->session->set_flashdata('flash_info', 'Choose Exam, Class and Subject');
    ...
    function manage_profile($param1 = '', $param2 = '', $param3 = '')
    {
        ...
        if ($param1 == 'update_profile_info') {
            ...
            $this->session->set_flashdata('flass_success', 'Account Updated!');
    ...
    function manage_attendance($date = '', $month = '', $year = '', $class_id = '')
    {
        ...
        if ($_POST) {
            ...
            $this->session->set_flashdata('flass_success', 'Successfully Updated!');
